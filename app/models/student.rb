class Student < ApplicationRecord
  ...
  validates :marksheet, presence: true, attached: true, content_type: { in: "application/pdf", message: "is not a PDF" }, size: { less_than: 5.megabytes, message: " is too large!" }
end
